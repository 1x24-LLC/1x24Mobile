  ...
  return (
    <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
      <View style={{ flexDirection: "row" }}>
        ...
        <TouchableOpacity style={GlobalStyles.Card.touchable}>
          <IconMaterialIcons name="delete-outline" size={24} color="#000" />
        </TouchableOpacity>
        <TouchableOpacity style={GlobalStyles.Card.touchable}>
          <IconMaterialIcons name="query-stats" size={24} color="#000" />
        </TouchableOpacity>
        <TouchableOpacity style={GlobalStyles.Card.touchable}>
          <IconMaterialIcons name="edit-note" size={24} color="#000" />
        </TouchableOpacity>
      </View>
      <View style={{ flexDirection: "row" }}>
        <TouchableOpacity style={GlobalStyles.Card.touchable}>
